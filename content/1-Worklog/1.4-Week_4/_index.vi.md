...
## Mục Tiêu Tuần 4
- Bắt đầu lập trình dịch vụ xác thực backend và frontend
- Thảo luận và liệt kê các API cần thiết cho dịch vụ TaskFlow
- Học và thực hành dịch vụ S3
...
| 3    | - Lập trình backend Authentication Service                                                 | 01/10/2025   | 01/10/2025      |                                                                                                     |
|      | - Khởi tạo dự án (React, cấu hình môi trường, thiết lập routing cơ bản, cấu trúc thư mục, tích hợp Git) |              |                 |                                                                                                     |
